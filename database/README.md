...
- 기존 V14 MySQL DB: `mysql/migration/V15__add_offer_declined_to_application_status.sql` 실행
- PostgreSQL: `postgresql/ddl/firstday_postgresql_current.sql` 확인
- 테이블 정의 확인: `docs/firstday_table_column_dictionary_v15.docx` (V15 반영 완료)
